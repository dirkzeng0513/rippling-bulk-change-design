...
const mockEmployeeData = {
  "1": { name: "Sarah Chen", currentJobTitle: "IC", currentLevel: "L4", currentDepartment: "EPD" },
  "2": { name: "Marcus Johnson", currentJobTitle: "IC", currentLevel: "L3", currentDepartment: "EPD" },
  "3": {
  ...
  "4": { name: "James Wilson", currentJobTitle: "IC", currentLevel: "L3", currentDepartment: "Sales" },
  "5": {
    name: "Anna Thompson",
    currentJobTitle: "Sr.Manager",
    currentLevel: "L5",
                                            ...
                                            {field.descriptions?.[option] && (
                                              <TooltipContent side="left" className="max-w-sm bg-white">
                                                <div className="space-y-1">
                                                  ...
                                                  <p className="text-xs text-gray-600">{field.descriptions[option]}</p>
                                                </div>
                                              </TooltipContent>
                                            )}
                                          </Tooltip>
